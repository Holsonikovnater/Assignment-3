...
Customer(){} 
//Parameter 
RegularCustomer::RegularCustomer(std::string _name, std::string _address, std::string _telephoneNumber):
Customer(_name, _address,_telephoneNumber){}
//Copy 
RegularCustomer::RegularCustomer(const Customer& otherCustomer):
